...
import com.jspiders.ds.LinkedList.SingleNode; //last node address is not null it is address of head node so that it will circle
...
public class CircularLinkedList {
	...
	public CircularLinkedList(int valueToBeInsert) {
